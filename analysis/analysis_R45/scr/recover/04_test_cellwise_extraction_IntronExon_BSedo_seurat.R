...
df_test4_intron <- fread("/beegfs/scratch/ric.absinta/ric.absinta/analysis/BS_run05/test/Sample_W8_untreated_Wintron_test/summarized_feature_test_intron_cellBarcodes.txt", sep = " ", header = FALSE)
df_test4_exon <- fread("/beegfs/scratch/ric.absinta/ric.absinta/analysis/BS_run05/test/Sample_W8_untreated_Wintron_test/summarized_feature_test_exon_cellBarcodes.txt", sep = " ", header = FALSE)
...
sparse_matrix_all <- sparse_matrix_exon + sparse_matrix_intron
...
df_extracted_intron <- rowSums(sparse_matrix_intron) %>%
  data.frame() %>%
  setNames("count_intron") %>%
  rownames_to_column("gene")

df_extracted_exon <- rowSums(sparse_matrix_exon) %>%
  data.frame() %>%
  setNames("count_exon") %>%
  rownames_to_column("gene")
...
saveRDS(sparse_matrix_exon,"../out/object/sparse_matrix_exon_BSedo_seurat.rds")
saveRDS(sparse_matrix_intron,"../out/object/sparse_matrix_intron_BSedo_seurat.rds")
