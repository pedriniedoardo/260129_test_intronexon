...
lapply(files,function(file_id){
  ...
  file_intron <- paste0("/beegfs/scratch/ric.cosr/ric.cosr/CRtest_genova_pedrini/cellranger/cellranger7/output/",
                        file_id,
                        "/outs/summarized_feature_test_intron_cellBarcodes.txt")
  
  file_exon <- paste0("/beegfs/scratch/ric.cosr/ric.cosr/CRtest_genova_pedrini/cellranger/cellranger7/output/",
                      file_id,
                      "/outs/summarized_feature_test_exon_cellBarcodes.txt")
  ...
  saveRDS(sparse_matrix_exon,paste0("../out/object/sparse_matrix_exon_",file_id,"_seurat.rds"))
  saveRDS(sparse_matrix_intron,paste0("../out/object/sparse_matrix_intron_",file_id,"_seurat.rds"))
})
...
list_sparse_matrix <- lapply(files,function(file_id){
  # print(x)
  sparse_matrix_intron <- readRDS(paste0("../out/object/sparse_matrix_intron_",file_id,"_seurat.rds"))
  sparse_matrix_exon <- readRDS(paste0("../out/object/sparse_matrix_exon_",file_id,"_seurat.rds"))
