...
# read in the data --------------------------------------------------------
list_df_tot <- readRDS("../out/object/list_intronic_metrics_seurat.rds")
...
pdf("../out/plot/02_upset_intronic_seurat.pdf",width = 6,height = 4,onefile=FALSE)
...
df_int %>%
  write_tsv("../out/table/02_df_intersection_seurat.tsv")
