...
rclone copy -PL /beegfs/scratch/ric.cosr/pedrini.edoardo/project_edoardo/260129_test_IntonExon/out \
gdrive_edo:work/analysis/personal/260129_test_IntonExon/out
